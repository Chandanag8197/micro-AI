...
export default function PythonDataAnalysis() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=python-data-analysis");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Python for Data Analysis (Pandas, NumPy)</h1>
        <p>
          Welcome to the Python for Data Analysis page! Here you can learn about Pandas, NumPy, and data manipulation in Python.
        </p>

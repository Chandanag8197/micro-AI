...
export default function PerformanceTesting() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/api/questions/random?topics=performance-testing`);
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        ...
        <p>
          Welcome to the Performance Testing page! Here you can learn about load testing, stress testing, and related tools.
        </p>

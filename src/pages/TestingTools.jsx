...
export default function TestingTools() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/api/questions/random?topics=testing-tools`);
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Testing Tools (Selenium, JMeter)</h1>
        <p>
          Welcome to the Testing Tools page! Here you can learn about Selenium, JMeter, and other popular testing tools.
        </p>

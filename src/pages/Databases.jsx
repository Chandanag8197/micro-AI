...
export default function Databases() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=databases");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Databases (SQL/NoSQL)</h1>
        <p>
          Welcome to the Databases page! Here you can learn about SQL, NoSQL, queries, normalization, and more.
        </p>

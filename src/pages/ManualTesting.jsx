  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Manual Testing Fundamentals</h1>
        <p>
          Welcome to the Manual Testing Fundamentals page! Here you can learn about test cases, test plans, bug reporting, and more.
        </p>

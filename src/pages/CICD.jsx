...
export default function ContinuousTestingCICD() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=continuous-testing-cicd");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Continuous Testing in CI/CD</h1>
        <p>
          Welcome to the Continuous Testing in CI/CD page! Here you can learn about automated pipelines, integration, and deployment testing.
        </p>

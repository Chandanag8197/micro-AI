...
export default function DebuggingTesting() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=debugging-testing");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        ...
        <p>
          Welcome to the Debugging & Testing page! Here you can learn about debugging tools, unit testing, integration testing, and more.
        </p>

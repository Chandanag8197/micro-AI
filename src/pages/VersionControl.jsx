...
export default function VersionControl() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/api/questions/random?topics=version-control`);
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        ...
        <p>
          Welcome to the Version Control page! Here you can learn about Git, branching, merging, and more.
        </p>

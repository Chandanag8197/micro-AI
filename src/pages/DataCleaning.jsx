...
export default function DataCleaning() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=data-cleaning");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Data Cleaning</h1>
        <p>
          Welcome to the Data Cleaning page! Here you can learn about handling missing values, duplicates, and data consistency.
        </p>

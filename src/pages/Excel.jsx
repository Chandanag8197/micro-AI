...
export default function ExcelFormulasFunctions() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=excel-formulas-functions");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Excel Formulas & Functions</h1>
        <p>
          Welcome to the Excel Formulas & Functions page! Here you can learn about VLOOKUP, SUMIF, pivot tables, and more.
        </p>

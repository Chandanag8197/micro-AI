...
export default function ExploratoryDataAnalysis() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/api/questions/random?topics=exploratory-data-analysis`);
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        ...
        <p>
          Welcome to the Exploratory Data Analysis page! Here you can learn about EDA techniques, data profiling, and visualization.
        </p>

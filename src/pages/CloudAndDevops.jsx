...
export default function CloudDevOpsBasics() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/questions/random?topics=cloud-devops-basics");
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>Cloud & DevOps Basics</h1>
        <p>
          Welcome to the Cloud & DevOps Basics page! Here you can learn about cloud computing, CI/CD, containers, and more.
        </p>

...
export default function BackendDevelopment() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/api/questions/random?topics=backend-development`);
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        ...
        <p>
          Welcome to the Backend Development page! Here you can learn about Node.js, Express, APIs, databases, and more.
        </p>

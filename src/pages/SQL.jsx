...
export default function SQLQueries() {
  ...
  const fetchRandomQuestion = async () => {
    try {
      ...
      const res = await axios.get(`${baseUrl}/api/questions/random?topics=sql-queries`);
  ...
  return (
    <div className="topic-bg">
      <div className="topic-content">
        <h1>SQL Queries (Joins, Aggregations)</h1>
        <p>
          Welcome to the SQL Queries page! Here you can learn about joins, aggregations, subqueries, and more.
        </p>
        ...
        <div className="ai-question-box">
          ...
          <button onClick={fetchRandomQuestion} title="Get New Question" style={{ marginLeft: 10 }}>🔄</button>
